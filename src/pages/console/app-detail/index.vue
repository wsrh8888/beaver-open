...
import BasicInfoPanel from './components/basic-info/index.vue'
import CredentialPanel from './components/credential/index.vue'
import BotPanel from './components/bot/index.vue'
import OAuthPanel from './components/oauth/index.vue'
import EventPanel from './components/event/index.vue'
import PermissionPanel from './components/permission/index.vue'
import SecurityPanel from './components/security/index.vue'
import VersionPanel from './components/version/index.vue'
